				...
				?>
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" heigth="317px" src="../Admin/DonShapra-Oficial/Private/View/assets/images/productos/<?php echo $imagen; ?>" alt="" >
								<div class="product-details">
									...
									<div class="prd-bottom">
										...
										<a  href="mostrardetalle.php?id=<?php echo $id ?> "class="social-info">
